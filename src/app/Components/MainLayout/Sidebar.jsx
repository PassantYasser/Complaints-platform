    ...
    >
      ...
      >
        {open ?(
          <div className='flex  items-center'>
            <img src='/logoiconch.png' alt="dd" className='w-30 h-20 bg-amber-500 ' />
          </div>
        
        ):(
          <div className='flex items-center '>
            <img src='/logoiconch.png' alt="dd"className='w-15 h-10' />
          </div>
        )}
      </button>
      ...
      <nav className="flex-1">
        <ul className='flex flex-col h-full'>
          ...
          <li className={`cursor-pointer py-4 px-2 rounded ${pathname === "/Complaints" ? "bg-[#C69815] text-[#fff]" : ""}`}>
            <Link href="/Complaints"  onClick={() => setIsSidebarOpen(false)} >
                {open?(
                //open 
                  <div  className='flex gap-4 items-center'>
                    <img src="/images/icons/dashboard.svg" alt="" className={pathname === "/Complaints" ? "invert" : ""}/>
                    <p className='text-base text-[#364152] font-normal'>{t('Complaints')}</p>
                  </div>
                ):(
